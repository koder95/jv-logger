...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        log.debug("Method completeOrder was called with: user #{}", userId);
        ...
        order.setOrderId(1L);
        log.info("Order #{} was completed for user #{}", order.getOrderId(), userId);
        return order;
    }
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        log.info("Data from DB was successfully fetched for user #{}", userId);
        return products;
    }
}
